...
<div id="content" class="px-4 py-1 p-md-5">
    ...
    <section>
        <div class="row">
            ...
            <div class="col-3">
                <a href="/pembimbing-lapangan/create" class="btn btn-primary mb-2"><i class="bi bi-plus-square"></i> Tambah Data</a>
            </div>
        </div>
        <div>
            @foreach ($pembimbing as $data)
            ...
            <table class="table mb-0 text-center table-striped table-sm">
                ...
                @forelse ($pembimbing as $data)
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('pembimbing-lapangan.destroy', $data->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
                        ...
                        <td>
                            <a href="/pembimbing-lapangan/edit/{{$data->id}}" class="btn btn-primary" title="edit"><i class="bi bi-pencil"></i></a>            
                        </td>
                    </tr>
                @empty
                @endforelse>
